...
class TestPdf(unittest.TestCase):
    ...
    def test_convert_pdfminer(self, not_found_mock):
        ...
        out = topicexplorer.lib.pdf.convert("/opt/anaconda/lib/python3.6/site-packages/www/papers/aaai15-topic-explorer-demo.pdf")
    ...
    def test_main(self):
        output_dir = mkdtemp()
        topicexplorer.lib.pdf.main("/opt/anaconda/lib/python3.6/site-packages/www/papers/aaai15-topic-explorer-demo.pdf",
    ...
    def test_convert_and_write(self):
        output_dir = mkdtemp()
        topicexplorer.lib.pdf.convert_and_write("/opt/anaconda/lib/python3.6/site-packages/www/papers/aaai15-topic-explorer-demo.pdf",
